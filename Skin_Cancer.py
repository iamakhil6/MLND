...
best_model= ModelCheckpoint('skin_cancer.hdf5', save_best_only=True, verbose=1)
# stop= EarlyStopping(monitor='val_loss', patience=2)
model.fit_generator(train_data, epochs=1, validation_data= valid_data, shuffle= True,callbacks= [best_model])
